...
metric.desc <- c("Web of Science Core Collection Times Cited Count", 
                 "Crossref citation counts", 
                 "Scopus citation counts", 
                 "CWTS citation counts - excluding self-citations", 
                 "Total Field-Normalized Citation Score. CWTS citation impact of article relative to the primary field to which the article belongs.",
                 "The total scite citation count from publication until year 2020.", 
                 "Altmetric score",
...
cor.dat.rv <- select(.data = data.all, 
                     ...
                     RV_scite,
                     RV_alt)
names(cor.dat.rv) <- c("Web of Science", "Scopus", "Field-normalized", "scite", "Altmetric")
