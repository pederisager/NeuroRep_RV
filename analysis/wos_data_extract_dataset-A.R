...
write.table(file = "../processed_data/dataset_A_wos.tsv", sep = "\t", x = datasetA, row.names = FALSE)
write.table(file = "../processed_data/dataset_A__wos_sparse.tsv", sep = "\t", x = datasetA_sparse, row.names = FALSE)
...
write.table(file = "../processed_data/dataset_A_wos.tsv", sep = "\t", x = datasetA, row.names = FALSE)
saveRDS(object = datasetA, file = "../processed_data/dataset_A_wos.rds")  # rds version of this data needed due to file encoding issues with the .tsv file
write.table(file = "../processed_data/dataset_A__wos_sparse.tsv", sep = "\t", x = datasetA_sparse, row.names = FALSE)
write.table(file = "../processed_data/dataset_A__wos_added500.tsv", sep = "\t", x = datasetA_added500, row.names = FALSE)
